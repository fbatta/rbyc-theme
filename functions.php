...
function twentytwenty_parent_theme_enqueue_styles()
{
    ...
    // splide
    wp_enqueue_script('splide-js', 'https://cdn.jsdelivr.net/npm/@splidejs/splide@latest/dist/js/splide.min.js', null);
    wp_enqueue_style('splide-css', 'https://cdn.jsdelivr.net/npm/@splidejs/splide@latest/dist/css/splide.min.css', null);

    // inputmask
    wp_enqueue_script('inputmask', get_stylesheet_directory_uri() . '/assets/js/jquery.inputmask.min.js', array('jquery'));
    // inputmask bindings
    wp_enqueue_script('inputmask-bindings', get_stylesheet_directory_uri() . '/assets/js/inputmask.bindings.js', array('inputmask'));
